...
const techStack = [
  {
    ...
    langName: "Java",
    langDesc: "<li>Java is a high-level, class-based, object-oriented programming language</li>",
  },
  {
    langImage: "assets/images/techstack-page/springboot.png",
    langName: "Spring Boot",
    langDesc: "<li>Spring Boot makes it easy to create stand-alone, production-grade Spring based Applications that you can just run.</li>",
  },
  {
